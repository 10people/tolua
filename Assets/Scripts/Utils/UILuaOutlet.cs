...
namespace KSFramework
{
	...
	public class UILuaOutlet : MonoBehaviour
	{
	    ...
	    public LuaTable m_TargetLuaTable;

	    public void SetLuaTable()
	    {
	        if (m_TargetLuaTable == null)
	        {
	            return;
	        }
	        ...
	        {
	            m_TargetLuaTable[item.Name] = ((GameObject) item.Object).GetComponent(item.ComponentType);
	        }
        }
	}
}
